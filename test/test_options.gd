...
func test_set_level() -> void:
	...
	assert_eq(instance._level, HanpekiLogger.FATAL | HanpekiLogger.WARN | HanpekiLogger.CORE | HanpekiLogger.DEBUG)
...
func test_enable_levels_from() -> void:
	...
	assert_eq(instance._level, HanpekiLogger.FATAL | HanpekiLogger.ERROR | HanpekiLogger.WARN | custom_level)
